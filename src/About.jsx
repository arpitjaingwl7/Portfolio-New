...
<div>
<div className='Big' style={{backgroundColor:theme=="dark"?"#0F0F0F":"#F4DFB6"}}>
<div className="profile-card" style={{backgroundColor:theme=="dark"?"#005B41":"white",color:theme=="dark"?"white":"black"}} >

    <header style={{backgroundColor:theme=="dark"?"#005B41":"white",color:theme=="dark"?"white":"black"}}>
    ...
    <div className="profile-bio" style={{backgroundColor:theme=="dark"?"#005B41":"white",color:theme=="dark"?"white":"black"}}>
    ...
    <ul className="profile-social-links"  style={{backgroundColor:theme=="dark"?"#005B41":"white",color:theme=="dark"?"white":"black"}}>
